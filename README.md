...
powershell -NoProfile -ExecutionPolicy Bypass -File .\clean-script.ps1 -Authorization 'wp1N$ARPhNhN+Xy5t6' -DryRun

# 真正执行删除（去掉 -DryRun）
powershell -NoProfile -ExecutionPolicy Bypass -File .\clean-script.ps1 -Authorization 'wp1N$ARPhNhN+Xy5t6'
```
